    ...
    return (
        ...
        <div className="container-fluid" style={{backgroundColor:"#f5e5d0"}}>
            <div className="container footer d-flex justify-content-between align-items-center">
                <div className="d-flex align-items-end m-0 p-0">
                    <p className="trademark mb-0">© 2025 Giulato Gelato<br />
                    <span className="designed">Designed by Haus of Rogue <br />
                    Developed by Sunny Gian</span></p>
                </div>
                <div className="d-flex align-items-center">
                    <a href="https://www.instagram.com/giulatogelato" target="_blank"><i className="insta bi bi-instagram me-5" style={{fontSize:"1.5rem", color: "black"}}></i></a>
